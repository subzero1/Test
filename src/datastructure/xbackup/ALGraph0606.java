...
public class ALGraph0606 {
     ...
     */
    public ALGraph0606(VertexNode[] vertexArray, String[] arcArray) {
...
//        System.out.println("访问:"+adjlist[v].vertex);
    ...
    public void BFSTraverse(int v){
        ...
        while (front!=rear){
            ...
            while (pNode!=null){
                int p=pNode.adjvex;
                if (!visited[p]){
                    System.out.println("访问:"+adjlist[p].vertex);
                    visited[p]=true;
                    Q[++rear]=p;
                }
                pNode=pNode.next;
    ...
    public static void main(String[] args) {
        ...
        arcArray[6]="3#0";
        arcArray[7]="3#1";
        ALGraph0606 graph=new ALGraph0606(vertexNodes,arcArray);
//        graph.DFSTraverse(0);
        graph.BFSTraverse(0);
    }
}
