...
public class ALGraph0622 {
     ...
     */
    public ALGraph0622(VertexNode[] vertexArray, String[] arcArray) {
...
//        System.out.println("访问:"+adjlist[v].vertex);
    ...
    public static void main(String[] args) {
        ...
        arcArray[6] = "3#0";
        arcArray[7] = "3#1";
        ALGraph0622 graph = new ALGraph0622(vertexNodes, arcArray);
//        graph.DFSTraverse(0);
        graph.BFSTraverse(0);
    }
}
